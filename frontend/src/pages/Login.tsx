            ...
            <section className="hidden lg:flex flex-col justify-between bg-[#0A0A0A] text-white p-12 relative overflow-hidden">
                ...
                <div className="relative z-10">
                    <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-sm text-neutral-300">
                        ...
                        New season essentials now available
                    </div>
                    ...
                    <p className="mt-6 max-w-lg text-neutral-300 text-lg leading-7">
                        Discover quality essentials, manage your cart, and track every order
                ...
                <div className="relative z-10 grid grid-cols-3 gap-4">
                    ...
                    <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                        ...
                        <p className="text-sm text-neutral-400 mt-1">Shopping</p>
                    </div>
                ...
                >
                    <div className="mb-8">
                        ...
                        <p className="mt-2 text-sm text-neutral-500">
                            Sign in to manage continue shopping and manage your orders.
                        </p>
                    </div>
                    ...
                    <p className="mt-6 text-center text-sm text-neutral-600">
                        New here?{" "}
                        <Link to="/register" className="font-semibold text-[#0A0A0A] underline">
                            Create account
                        </Link>
                    </p>
                </form>
